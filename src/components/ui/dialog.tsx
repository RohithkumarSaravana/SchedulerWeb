  ...
  return (
    <DialogPrimitive.Portal>
      ...
      <DialogPrimitive.Content
        className={cn(
          "fixed left-1/2 top-1/2 z-50 w-full max-w-lg -translate-x-1/2 -translate-y-1/2 rounded-[var(--radius-lg)] border border-steel-line bg-surface p-5 shadow-xl",
          className
        )}
        {...props}
      >
...
export function DialogDescription({
  ...
  return <DialogPrimitive.Description className={cn("mt-1 text-[13px] text-ink-soft", className)} {...props} />;
}
